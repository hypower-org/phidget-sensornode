...
/**
 * Example class using the Phidget manager to look for new phidgets attached to the system.
 * @author pjmartin
 *
 */
        ...
        try {
            ...
            mgr.addAttachListener(new AttachListener(){
                ...
                public void attached(AttachEvent ae) {
                    try {
                        System.out.println("Phidget attached: " + ae.getSource().getDeviceName() + " sn=" + ae.getSource().getSerialNumber());
